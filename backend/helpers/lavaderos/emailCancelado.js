...
const emailCancelado = async (datos) => {
  ...
  const info = await transporter.sendMail({
    ...
    to: email,
    subject: "Cancelación de Reserva en LavaSoft",
    html: `
    ...
    <p style="font-size: 18px;">Lamentamos informarte que tu reserva en ${capitalizeFirstLetter(lavadero)} ha sido cancelada.</p>
    </div>
